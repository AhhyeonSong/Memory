...
public class ViewPagerActivity extends ActionBarActivity {
    ...
    static ArrayList<ContentItem> getSampleContent() {
        ...
        items.add(new ContentItem(ContentItem.CONTENT_TYPE_IMAGE, "hangang1.jpg"));
        ...
        items.add(new ContentItem(ContentItem.CONTENT_TYPE_IMAGE, "hangang2.jpg"));
        items.add(new ContentItem(ContentItem.CONTENT_TYPE_TEXT, R.string.quote_3));
        items.add(new ContentItem(ContentItem.CONTENT_TYPE_IMAGE, "hangang3.jpg"));
